...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"Select the spreadsheet:", None))
        self.lineedit_data_file.setPlaceholderText(QCoreApplication.translate("MainWindow", u"No File Selected.", None))
#if QT_CONFIG(tooltip)
        self.btn_data_file.setToolTip(QCoreApplication.translate("MainWindow", u"Browse spreadsheet", None))
#endif // QT_CONFIG(tooltip)
